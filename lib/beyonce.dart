...
class beyounce extends StatefulWidget {
  @override
  _beyounceState createState() => _beyounceState();
}

class _beyounceState extends State<beyounce> {
              ...
              child: GestureDetector(
                onTap: () async {
                  try {
                    ...
                    await _audioPlayer.setAsset('assets/audio/Beyonce.mp3');
                    // Play the audio
                    _audioPlayer.play();
                  } catch (e) {
                ...
                child: ClipOval(
                  child: Image.asset("assets/images/beyouncy.jpg"),
                ),
              ),
            ),
            ListTile(
              title: Text(
                "This is Beyonce ,click the image to play music!",
                style: TextStyle(
                  fontSize: 25,
                  color: Colors.white,
                ),
