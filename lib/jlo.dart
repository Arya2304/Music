...
class jlo extends StatefulWidget {
  @override
  _jloState createState() => _jloState();
}

class _jloState extends State<jlo> {
              ...
              child: GestureDetector(
                onTap: () async {
                  try {
                    ...
                    await _audioPlayer.setAsset('assets/audio/jlo.mp3');
                    // Play the audio
                    _audioPlayer.play();
                  } catch (e) {
                ...
                child: ClipOval(
                  child: Image.asset("assets/images/jlo.jpg"),
                ),
              ),
            ),
            ListTile(
              title: Text(
                "This is Jennifer Lopez ,click the image to play music!",
                style: TextStyle(
                  fontSize: 25,
                  color: Colors.white,
                ),
