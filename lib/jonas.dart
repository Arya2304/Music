...
class jonas extends StatefulWidget {
  @override
  _jonasState createState() => _jonasState();
}

class _jonasState extends State<jonas> {
              ...
              child: GestureDetector(
                onTap: () async {
                  try {
                    ...
                    await _audioPlayer.setAsset('assets/audio/jonas.mp3');
                    // Play the audio
                    _audioPlayer.play();
                  } catch (e) {
                ...
                child: ClipOval(
                  child: Image.asset("assets/images/jonas.jpg"),
                ),
              ),
            ),
            ListTile(
              title: Text(
                "This is Jonas Brothers ,click the image to play music!",
                style: TextStyle(
                  fontSize: 25,
                  color: Colors.white,
                ),
