...
class maroon extends StatefulWidget {
  @override
  _maroonState createState() => _maroonState();
}

class _maroonState extends State<maroon> {
              ...
              child: GestureDetector(
                onTap: () async {
                  try {
                    ...
                    await _audioPlayer.setAsset('assets/audio/maroon.mp3');
                    // Play the audio
                    _audioPlayer.play();
                  } catch (e) {
                ...
                child: ClipOval(
                  child: Image.asset("assets/images/marron.jpg"),
                ),
              ),
            ),
            ListTile(
              title: Text(
                "This is Maroon 5 ,click the image to play music!",
                style: TextStyle(
                  fontSize: 25,
                  color: Colors.white,
                ),
