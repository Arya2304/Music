...
class monali extends StatefulWidget {
  @override
  _monaliState createState() => _monaliState();
}

class _monaliState extends State<monali> {
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
              ...
              child: GestureDetector(
                onTap: () async {
                  try {
                    ...
                    await _audioPlayer.setAsset('assets/audio/monali.mp3');
                    // Play the audio
                    _audioPlayer.play();
                  } catch (e) {
            ...
            ListTile(
              title: Text(
                "This is Monali Thakur ,click the image to play music!",
                style: TextStyle(
                  fontSize: 25,
                  color: Colors.white,
                ),
