...
class neha extends StatefulWidget {
  @override
  _nehaState createState() => _nehaState();
}

class _nehaState extends State<neha> {
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
              ...
              child: GestureDetector(
                onTap: () async {
                  try {
                    ...
                    await _audioPlayer.setAsset('assets/audio/neha.mp3');
                    // Play the audio
                    _audioPlayer.play();
                  } catch (e) {
            ...
            ListTile(
              title: Text(
                "This is Neha Kakkar ,click the image to play music!",
                style: TextStyle(
                  fontSize: 25,
                  color: Colors.white,
                ),
