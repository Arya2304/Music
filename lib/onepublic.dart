...
class onep extends StatefulWidget {
  @override
  _onepState createState() => _onepState();
}

class _onepState extends State<onep> {
              ...
              child: GestureDetector(
                onTap: () async {
                  try {
                    ...
                    await _audioPlayer.setAsset('assets/audio/op.mp3');
                    // Play the audio
                    _audioPlayer.play();
                  } catch (e) {
                ...
                child: ClipOval(
                  child: Image.asset("assets/images/op.jpg"),
                ),
              ),
            ),
            ListTile(
              title: Text(
                "This is One Public ,click the image to play music!",
                style: TextStyle(
                  fontSize: 25,
                  color: Colors.white,
                ),
