...
class salim extends StatefulWidget {
  @override
  _salimState createState() => _salimState();
}

class _salimState extends State<salim> {
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
              ...
              child: GestureDetector(
                onTap: () async {
                  try {
                    ...
                    await _audioPlayer.setAsset('assets/audio/salim.mp3');
                    // Play the audio
                    _audioPlayer.play();
                  } catch (e) {
            ...
            ListTile(
              title: Text(
                "This is Salim-Sulaiman ,click the image to play music!",
                style: TextStyle(
                  fontSize: 25,
                  color: Colors.white,
                ),
