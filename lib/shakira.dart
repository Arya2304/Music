...
class shakira extends StatefulWidget {
  @override
  _shakiraState createState() => _shakiraState();
}

class _shakiraState extends State<shakira> {
              ...
              child: GestureDetector(
                onTap: () async {
                  try {
                    ...
                    await _audioPlayer.setAsset('assets/audio/shakira.mp3');
                    // Play the audio
                    _audioPlayer.play();
                  } catch (e) {
                ...
                child: ClipOval(
                  child: Image.asset("assets/images/shakira.jpg"),
                ),
              ),
            ),
            ListTile(
              title: Text(
                "This is Shakira ,click the image to play music!",
                style: TextStyle(
                  fontSize: 25,
                  color: Colors.white,
                ),
