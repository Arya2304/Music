...
class shreya extends StatefulWidget {
  @override
  _shreyaState createState() => _shreyaState();
}
              ...
              child: GestureDetector(
                onTap: () async {
                  try {
                    ...
                    await _audioPlayer.setAsset('assets/audio/shreya.mp3');
                    // Play the audio
                    _audioPlayer.play();
                  } catch (e) {
                ...
                child: ClipOval(
                  child: Image.asset("assets/images/sg.jpg"),
                ),
              ),
            ),
            ListTile(
              title: Text(
                "This is Shreya Ghoshal ,click the image to play music!",
                style: TextStyle(
                  fontSize: 25,
                  color: Colors.white,
                ),
